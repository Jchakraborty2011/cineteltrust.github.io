                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="bg-light border-bottom border-5 border-primary rounded p-4 mb-4">
                            <p class="text-dark mb-2">Group Personal Accident and Medical Insurance Policies
                            </p>
                            <!-- <span class="text-primary">Jhon Doe, Founder</span> -->
                        </div>
                        <p class="mb-3">
                            A landmark step taken by the Trust. This will cater to medical needs of the technicians, artists and workers in a big way. So far 623 personnel are covered under the scheme and more will be provided with this coverage in future. The financial coverage are Rs. 1,00,000 and Rs. 50,000 for Group Personal Accident Policy and Medical Insurance Policy respectively.
                        </p>
